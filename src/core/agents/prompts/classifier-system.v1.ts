// v1 of the classifier system prompt. PRESERVED FOR DIFFING ONLY — the
// active export is in classifier-system.ts which now points at v2. Do not
// import this file from runtime code.
//
