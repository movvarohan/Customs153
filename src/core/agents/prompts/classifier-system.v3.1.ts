// v3.1 of the classifier system prompt. Active.
//
// Diff from v3:
//   - Adds a "Rule precedence when guidance conflicts" section between the
//     Specificity Rule and the Failure-modes block. Five-step precedence
//     order: notes → principal function → GRI 1 specificity → Specificity
//     Rule → residual default.
//   - Adds a concrete carve-out for smartwatches and watch-like wearables
//     with smartphone connectivity / GPS / heart-rate / app functionality:
//     classify under 8517.62 by CBP HQ H312579 and follow-on rulings,
//     not 9102, despite the article having an electro-optical display.
//   - Targets the v3 regression in which 3 FBA smartwatches were surfaced
//     as ~$10K of phantom recoverable because v3's Specificity Rule on
//     the 9102.12 named criterion fought v3's footnote (D) Principal-
//     Function rule and won.

export const CLASSIFIER_PROMPT_VERSION = "v3.1-2026-05-13";
